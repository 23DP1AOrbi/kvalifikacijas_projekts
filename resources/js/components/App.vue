...
const updateTabMeta = () => {
  ...
  const mCirclePath = "M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7,17V7H9L12,10L15,7H17V17H15V9.23L12,12.23L9,9.23V17H7Z";
  
  const link = document.createElement('link');
  link.type = 'image/svg+xml';
  link.rel = 'icon';
  
  const svgString = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="%233B82F6" d="${mCirclePath}"/></svg>`;
